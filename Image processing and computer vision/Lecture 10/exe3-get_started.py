...
if __name__ == "__main__":
    ...
    # Let's try to calculate the length of the baseline... INSERT YOUR OWN CODE
    ...
    # Do the actual rectification using stereoRectify like in exercise 2

    # Remap the left image based on the resulting rotation rot1 and projection matrix P1
    leftmapX, leftmapY = cv2.initUndistortRectifyMap(... #INSERT YOUR OWN CODE
    left_remap = cv2.remap(left_gray, leftmapX, leftmapY, cv2.INTER_LANCZOS4)

    # Do the same for the right image... INSERT YOUR OWN CODE
    ...
    left_pts = np.array([[x1, y1],...[xn, yn]]) # INSERT YOUR OWN CODE
    ...
    linesR = cv2.computeCorrespondEpilines(... # INSERT YOUR OWN CODE
